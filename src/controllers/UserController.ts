...
//Editar senha
router.put("/senha-cliente/:id",verificarToken, async (req: Request, res: Response) => {
  try {
    const id = Number(req.params.id);
...
//Atualizar
router.put("/cliente/:id",verificarToken, async (req: Request, res: Response) => {
  try {
    const id = Number(req.params.id);
...
//deletar
router.delete("/cliente/:id",verificarToken, async(req:Request, res:Response)=>{
